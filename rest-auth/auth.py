...
# See https://github.com/Joichiro/chat/rest-auth for details.
...
def index():
    return 'Sample Tinode REST/JSON-RPC authentication service. '+\
        'See <a href="https://github.com/Joichiro/chat/rest-auth/">https://github.com/Joichiro/chat/rest-auth/</a> for details.'
